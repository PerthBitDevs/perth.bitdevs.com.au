...
3. Files go into `/YYYY-MM/` directory
4. Landing page `index.html` updated with new event entry
5. Push to `master` deploys
...
- `content-workflow.md` — GitHub issue → slide HTML pipeline
